...
var l_messages = [
	...
	"We have a zero-tolerance policy towards harassment or discrimination. Any instances of harassment, discrimination, hate speech, or personal attacks will not be tolerated and will be addressed promptly and appropriately!",
        "Please refrain from discussing sensitive topics. This server is not intended for debates on such matters. Let's maintain a positive atmosphere by avoiding topics that could lead to heated arguments!",
	"Please refrain from posting any personal information, including full names, addresses, phone numbers, and login details for any platform!",
	"Advertisements of any kind are prohibited, including forum posts, other Gmod servers, Twitch streams/channels, YouTube channels, and similar platforms!",
	...
	"Please refrain from sharing the FNAF movie musical Springbonnie clip more than once per day per person. Violating this rule may result in a 10-minute timeout!",
	...
	"Just a friendly reminder: Harassment or bullying is not tolerated here. Treating others with respect should be a basic expectation, even in today's world!",
	...
	"Please adhere strictly to the server-specific rules. Familiarize yourself with any additional guidelines specific to the server, such as character creation guidelines or faction regulations!",
	...
	"Permission for All KOS Rules will be granted, but solely under the default KOS regulations applicable to that area. You may utilize this option, or alternatively, manually set your KOS Rules!",
