...
var l_messages = [
	...
	"No discrimination based on race, gender, religion, sexual orientation, etc., or using slurs. Because apparently, discriminating and slurring are the latest trends!",
	"No behaviour or language which can be considered but not limited to; Harassment, Defamatory, Homophobic, Sexually Explicit, Encouragement of Self-Harm, Racially, Ethnically or otherwise offensive!",
	"Kindly report any instances of rule violations to the appropriate authorities. Tagging moderators without valid reason is not permitted!",
