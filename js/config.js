...
var l_messages = [
	...
	"Do not openly argue with forum diplomats or members of the senior management team. If you disagree with a decision made by a member of these groups, contact the Head Forum Diplomat or the Senior Management Team member via a direct message!",
	...
	"Listen to staff members at all times! If you think an admin has judged you unfairly, talk to another staff member and try to prove it!",
	"We have a Zero Tolerance Policy for pedo shit, Our community enforces a strict zero-tolerance policy towards any form of paedophilia, child exploitation, or grooming. Any individual found engaging in, promoting, or supporting such activities will be immediately blacklisted and banned from our platforms!",
	...
	"Do Not Random Deathmatch. RDM is killing or damaging a player without a legitimate RP reason!",
	"FearRP is basically a value for your life, as in real life. If you are held at gunpoint and mugged for $1000, you want to drop the money because if you don't, you will die. This works for raids, mugs, kidnappings, hostage situations, etc!",
	...
	"Please Don’t try to start any drama with other users. If it gets too crazy, you may be kicked or banned!",
	"Publicising private messages with another player unless the messages are used as evidence in a player report, staff report, warning appeal, or ban appeal is prohibited!",
	...
	"The community will provide resources and educational materials to raise awareness about the dangers of paedophilia and child exploitation in order to empower our members to identify and report potential threats.!",
	...
	"Symptoms of not following these rules are included, but not limited to: Death Ban Kick Herpies Jail Time Real Jail Time Super Herpies Just follow the rules. Thank you!",
	...
	"Swearing is allowed under the assumption that it is used respectfully and not as a way to harm others. Usage of slurs, whether it be f-gg-t, tr-nny, r-tard, the hard r, etc., is not allowed, and you can be punished!",
	...
	"Do not threaten players or make any regimental announcements or decisions in server-wide discussion unless it pertains to the whole community!",
