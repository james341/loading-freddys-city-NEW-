...
var l_messages = [
	"Please keep the atmosphere elegant and respectful; do not share any GIFs or offended material via text signs. The thematic essence of role-playing to be found on your signs will be more preferable. Please remember that expressions of racism, pornography, or denigration referring to religions are strictly forbidden here!",
	...
	"Do not beg for VIP Access or access to whitelisted jobs!",
	...
	"It is illegal to fire any weapon, other than a licensed pistol, and then only in self-defense, at any time. It is not illegal to have weapons, unless you have been caught by law enforcement brandishing them in public and/or firing or using them with intent to commit a crime. The only ban that says you cannot enter or attempt to enter any government facility and/or bank with any weapons unless you are a part of law enforcement or bank security!",
	...
	"Stay In-Character: Always act according to the traits and personality of your selected animatronic or human character!",
	...
	"A base can have a maximum of five players in a party - or gang - or organisation together. (/orgs) This includes up to a maximum of one battle medic. The gangster and mafia sides do not need to be in a gang or organisation and can have as many members in a base together as the server allows it. A base may wish to have players visit but they cannot buy or store printers, bitminers or job entities within your base. assist with countering a raid against your base unless they are a job that is allowed to counter active raids and are outside of the base at the time the raid is called and follow all Counter Raid Rules as set in the Raiding Rules above!",
