...
var l_messages = [
	...
	"Keeping things safe and fair: We want everyone to feel welcome here. That’s why we keep an eye on things, enforce our rules, and tweak them whenever needed to make sure the community stays chill and inclusive!",
	...
	"Check the rules now and then so you don’t get caught off guard. Staying informed = staying out of trouble!",
	...
	"In this community, we don’t raid other servers—and we don’t even joke about it. Try it, plan it, or hype it up!",
