...
var l_messages = [
	...
	"Reminder: Punishments are issued at staff discretion and may vary based on circumstances!",
	...
	"Just a reminder that punishments are determined by the staff member and may vary depending on the situation!",
	...
	"just a small Reminder it is up to the staff member to decide your punishment. It’s not always going to be exact!",
	...
	"No discussing sensitive topics. This is not a debate server — leave sensitive subjects out to prevent arguments and drama!",
	...
	"Advertising of any kind, including through direct messages, is strictly forbidden. Promoting other servers, communities, or services will result in moderation action!",
	...
	"Use common sense. Do not abuse exploits, loopholes around rules, or others!",
	"Look please Be respectful This means no mean, rude, or harassing comments. Treat others the way you want to be treated!",
	...
	"Do not abuse props actions like prop blocking, prop killing, prop bridging, and prop spamming are strictly prohibited!",
