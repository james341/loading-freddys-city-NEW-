...
var l_messages = [
	...
	"Adhere to Animatronic Behavior: Move slowly and with purpose, particularly during active hours!",
	...
	"Follow your character’s personality or programmed behavior (e.g., Freddy leads, Chica may search the kitchen, etc!",
	...
	"No Camping: Animatronics should not camp in one location, such as the office, for extended periods unless it aligns with RP or game mechanics!",
	"Follow rules regarding flashlights, tasers, or other defensive items. Do not abuse them!",
	"Zero Tolerance: Our community enforces a strict zero-tolerance policy towards any form of paedophilia, child exploitation, or grooming. Any individual found engaging in, promoting, or supporting such activities will be immediately blacklisted and banned from our platforms!",
	...
	"No metagaming or exploiting in-roleplay. It undermines the experience for those who approach roleplaying seriously!",
	...
	"Metagaming and attempting to take advantage of in-roleplay situations are prohibited, as they diminish the enjoyment for those who engage in roleplay with sincerity!",
