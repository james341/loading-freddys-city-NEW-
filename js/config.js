...
var l_messages = [
	...
	"Be respectful to every user within our community. This is not a place for you to harass, discriminate, disrespect, or be generally unkind towards people. Toxicity is never welcome here. Additionally, if you are found to be using DMs to threaten, doxx, sexually abuse, or grossly mistreat a user, you will be met with an immediate, non-negotiable ban. This does not apply to petty arguments or disputes!",
	...
	"Extremely discriminatory language (e.g., slurs, N-words, and Fa-words) isn’t welcome on this server and will be met with immediate punishment, ranging from a warning to an immediate ban depending on the severity and usage of said language. Discriminatory statements at large aren’t welcome either and will be met with appropriate sanctions!",
	"NSFW/NSFL explicit or shock material (Gore, graphic warfare footage, self-harm, etc.) in any form will result in a permanent ban. Overly sexual or suggestive content (such as converse, sexual language, overly revealing characters, etc.) in general is not permitted on our server and will be met with appropriate sanctions deemed fit by a moderator-on-duty!",
