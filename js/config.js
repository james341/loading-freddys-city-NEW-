...
var l_messages = [
	...
	"Only five players can be in a party - or gang - or organisation together in a base. Maximum one battle medic can be allowed in an orgs. The gangster and mafia sides do not need to be in a gang or organisation, and can have as many members as the server allows in a base together. A base may want to have players visit but they can't buy or store printers, bitminers or job entities within your base. help defend against a raid on your base unless they are a job that is allowed to defend active raids and are out of the base when the raid is called and adhere to all Counter Raid Rules set above in the Raiding Rules!",
