...
var l_messages = [
	...
	"No Excessive Killing: Animatronics should avoid excessive killing and focus on enhancing the role-play experience!",
	...
	"Heavy Arms Dealers may sell weapons legally. Non-Donator Gun Dealers must purchase a gun license from the Mayor!",
	...
	"Please refrain from activities that may compromise or exploit the integrity of the server!",
	...
	"Respect everyone. Refrain from swearing in /OOC, intentionally annoying others, or trolling!",
	"Survival Focus: The primary goal is to survive the night; use security systems wisely!",
	"No Prop Spamming: Do not spam props or build excessively, causing lag or disruption!",
	"These rules are designed to ensure a fun, immersive, and fair RP experience for everyone on the server!",
	"Limited Movement: Night guards should primarily stay in their designated area (e.g., security office!",
	"Respect All Players: Treat all players with respect. No harassment, bullying, or discrimination!",
