...
var l_musicPlaylist = [
	...
	{ogg: "instrumentalnotmyself.ogg", name: "Installation Music"},
...
var l_messages = [
	...
	"No Prop-Blocking – Don’t use props to block doors, hallways, or trap players!",
	...
	"The community team can update the rules whenever they need to—no warning required!",
	...
	"Uh, yeah, so, disagreements are, uh, normal and expected. But, uh, if you keep making negative comments or try to bypass a block or ban, well… that crosses the line into harassment, and, uh, that’s just not okay!",
