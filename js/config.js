...
var l_messages = [
	...
	"Please use common sense when being active and chatting in the server. Don't ecourage people to break rules, don't spam staff, etc. Use your brain!",
        "KOS signs most are placed at the entrance of a KOS area it must be sized and colored clearly any attempts to bait people into areas with obscure KOS signs will result in punishment from staff!",
	...
	"Adverts must be clear and understandable for players!",
	...
	"Mugging: Mugging is one of the most despised ways to play on DarkRP, however, it’s still allowed for player enjoyment!",
	"Raid | Pd-Raid | Assist | Counter | Mug | CarJack |Kidnap. If you wish to bind them. No mega binds, or combining counter and assist together (leads to a lot of confusion). Please!",
