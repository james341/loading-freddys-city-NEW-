...
var l_messages = [
	...
	"To ensure effective communication and moderation, use English in all in-game communications!",
	...
	"No Cheating or Exploiting: Cheating, hacking, or exploiting game mechanics for unfair advantage is strictly prohibited!",
	...
	"Keep it clean Avoid explicit language, NSFW content, or anything that could make others uncomfortable!",
	"Do not intentionally cause lag or disrupt server performance. Follow any specific rules regarding props, vehicles, or other server resources!",
	"Stay in character while in the server. Follow the established lore of the Day shift at Freddy's universe!",
	"No Prop Blocking or Prop Pushing: Do not use props to block doorways, trap players, or interfere with the gameplay of others!",
	"No Mic/Chat Spam: Avoid excessive use of voice or text chat that disrupts the gameplay experience for others!",
	"Stay in-character (IC) and avoid breaking immersion. Refrain from actions or speech that disrupt the roleplay environment!",
	...
	"Exploits and Cheating: Do not exploit bugs or use cheats. Report any glitches or issues to server staff!",
	"Don't metagame don't use information from outside of RP, e.g., the killfeed or someone's job title, in roleplay!",
	"There is be no advertising or promotional communication of other communities. This includes Direct Messages to mutual members of the discord!",
	...
	"Avoid excessive use of voice or text chat that disrupts gameplay or annoys other players!",
	...
	"Do NOT abuse props in any way, shape, or form. (no prop-blocking, prop-killing, prop-bridging, and prop-spamming!",
	...
	"Please use character names that are both appropriate and immersive within the context of our server. Avoid names that disrupt immersion or violate our community standards. Let's strive to maintain a cohesive and immersive roleplaying experience for all members!",
	...
	"Do not exploit glitches, hacks, or cheats. Report any bugs or issues to the server administrators!",
	...
	"Treat other players with respect and courtesy. Avoid offensive language, harassment, or discrimination!",
	"Animatronics cannot exit the Restaurant. They cannot chase players outside the restaurant, but they can do /me grabs the child before they leave!",
	...
	"Follow the instructions of server staff and admins. Report issues through the proper channels rather than engaging in arguments!",
	"Do not use third-party software or exploits to gain an unfair advantage. Report any bugs or glitches to the server staff!",
	...
	"Engage in roleplay specific to your in-game job or character background. Follow guidelines for each role or faction!",
	...
	"Encourage members to participate in server events and storylines. Events may include in-game activities, quests, or contests!",
	"Use English in global chat channels to ensure communication among all players!",
	"Create a believable character with a suitable backstory and characteristics. Avoid overpowered or unrealistic characters!",
	...
	"Use vehicles responsibly, and do not use them to harm others intentionally. Follow traffic rules in role-play situations!",
