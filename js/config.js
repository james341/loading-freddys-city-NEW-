...
var l_musicPlaylist = [
	...
	{ogg: "smokindsafmusic.ogg", name: "Installation Music"},
...
var l_messages = [
	...
	"Regardless of personal feelings, the regulations are established to be upheld. If you have concerns about them, please understand that adherence to these guidelines is required; otherwise, severe punishment will apply!",
	...
	"Personal opinions do not override server rules. All guidelines must be followed at all times failure to do so may lead to disciplinary action!",
	...
	"Listen, folks  it’s very simple. You play your animatronic, you use their abilities. Golden Freddy? He teleports, sure. Foxy? He doesn’t. Don’t make up powers, okay? We’ve got rules the best rules and everyone’s gotta follow them. Believe me!",
	...
	"Discrimination, slurs, or offensive remarks about race, gender, sexuality, religion, or any personal characteristics are prohibited. While light swearing is acceptable, excessive use should be avoided. Harassment in any form will not be tolerated!",
        "Wow, shocker  you're only supposed to use the abilities your animatronic actually has. So no, Foxy doesn’t suddenly get to teleport like Golden Freddy. Stick to your own gimmick, champ!",
	...
	"Uh, hey! So, if you’re playing a staff role—like, uh, a technician or a manager—make sure to, uh, follow the guidelines for your job. And, uh, yeah, don’t interfere with the gameplay unless it’s, you know, necessary!",
	"DDo not engage in arguments or introduce controversial topics in public chats. Any disputes should be resolved privately, either through direct messages or by contacting a staff member. Failure to comply will result in disciplinary action!",
	"Please remain in the office. Night guards should stay in the office at all times unless specific rules permit exploration during designated events!",
	...
	"Your privacy is safe with us. We do not collect your personal information, and we will never use it against you. We also do not sell or share any user data with third parties!",
	"Treat all members with kindness and courtesy. Discrimination, hate speech, or harassment will not be Tolerated!",
	...
	"Uh, hey! So, uh, just a quick heads-up—no saying slurs, like, uh, the N-word. If you do, you'll get timed out for an hour as a warning. Uh, you get two warnings, and if you still don't listen, well… uh, you’ll be kicked. So, uh, yeah—just keep it clean, alright? Thanks!",
	...
	"No advertising is allowed, whether public or through DMs. This includes servers, products, or services. Using our server to spam or promote to others will result in action!",
	...
	"Please don’t advertise your own stuff  whether it’s a server, product, or service — even in private messages. We want to keep the community spam-free for everyone!",
	...
	"Respect and kindness are expected at all times. Any remarks deemed rude or harmful will not be tolerated. Ensure this space remains welcoming for all!",
